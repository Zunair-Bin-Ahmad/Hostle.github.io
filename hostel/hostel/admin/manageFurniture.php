...
<?php
                ...
                <section class="app-user-list">
                    ...
                    <div class="card">
                        <div style="padding-bottom: 10px;" class="card-header">
                                    ...
                                    <a style="float: right;" href="add_furniture.php">
                                        ...
                                        <!-- <i data-feather='eye'></i> -->
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="edit_furniture.php?furniture_id=<?php echo $row['furniture_id']?>"><i data-feather='edit'></i> Edit</a>
                                                   <a class="dropdown-item" onclick="confirm_del(<?php echo $row['furniture_id']; ?>)" ><i data-feather='trash-2'></i> Delete</a>
                                                </div>
                                            </div>   
                                        </td>
    ...
    <script>
        ...
        function confirm_del(furniture_id) {
           const response = confirm("Are you sure you want to delete furniture image?");
           if (response==true) {
              window.location.href = "delete_furniture.php?furniture_id="+furniture_id
           }
        }
    </script>
</body>
