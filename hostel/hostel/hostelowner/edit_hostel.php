...
if (isset($_POST['submit'])) {
    ...
    $title=$_POST['title'];
    $price=$_POST['price'];
        $furniture_image=$_FILES['image']['name']; 
     if (empty($furniture_image)) {
    $furniture_image=$_POST['pfurniture_image'];
  }
  else{
     $furniture_image="images/".$_FILES['image']['name'];
    move_uploaded_file($_FILES['image']['tmp_name'],$furniture_image);
}

    $sql="UPDATE `furniture` SET `categoryId`='$categoryId',`title`='$title',`price`='$price',`image`='$furniture_image' WHERE `furniture_id`='$furniture_id'";
    $query=mysqli_query($conn,$sql);
    if (!$query) {
    $bnotadd='<div class=" alert alert-danger" >Furniture image  not updated!</div>';
        }
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a style="float: right;" href="manageHostel.php">
                                  ...
                                  <?php 
                                        include 'include/connection.php';
                                        $sql="SELECT * FROM `add_hostel` WHERE 1";
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" value="../admin/<?php echo "$hostimg" ?>" name="img0" required="">
                                        </div>
                                         <div class="form-group">
                                            <label>Room 1</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="des" value="<?php echo "$description"?> "required="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input type="text" class="form-control" value="<?php echo "$area" ?>" name="address" required="">
                                        </div>
                                       </div>
                                        <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Hostal Name</label>
                                            <input type="text" class="form-control" value="<?php echo "$area" ?>" name="hostname" required="">
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                                        ...
                                        <div class="form-group">
                                            <label>Rent</label>
                                            <input type="text" class="form-control" value="<?php echo "$rent" ?>" name="rent" required="">
                                        </div>
                                        <div class="form-group" >
                                            <label>Net Facility</label>
                                            <select class="form-control" value="<?php echo "$net" ?>" name="net" required>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <select class="form-control" value="<?php echo "$messcharge"?>" name="charges" required>
                                                <option value="select">Select....</option>
                                                <option value="1">Yes</option>
                                                <option value="2">No</option>
                                            </select>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <select class="form-control" value="<?php echo "$electcharges" ?>" name="electric" required>
                                                <option value="select">Select....</option>
                                                <option value="1">Yes</option>
                                                <option value="2">No</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo "$totalroom" ?>" name="totalroom" required="">
                                        </div>
                                        <div class="form-group">
                                            <label>Contact</label>
                                        ...
                                        <div class="form-group">
                                            <label>Map</label>
                                            <input type="text" class="form-control" value="<?php echo "$map"?>" name="map" required="">
                                        </div>
                                       </div>
                                       </div>
                                    </div>
