...
if (isset($_POST['submit'])) {
    ...
    if (!$query) {
    $bnotadd='<div class=" alert alert-danger" >Category  not updated!</div>';
        }
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo $row['category_name'] ?>" class="form-control" name="category_name" required="">
                                        </div>
